...
@section('pagetitle', 'Alumni profile')
            ...
            <form action="" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" required value="{{ $alumni->name }}" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="gender" id="gender" class="form-control" required readonly
                            value="{{ $alumni->gender == 1 ? 'Pria' : 'Wanita' }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="dob" id="dob" class="form-control" required value="{{ $alumni->dob }}"
                            readonly>
                    </div>
                </div>
